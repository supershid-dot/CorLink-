-- CorLink — T3F.2A dependency candidate management authorization
-- Additive/idempotent correction: preserve the established picker contract and
-- require management authority over both the current and candidate Tasks.
